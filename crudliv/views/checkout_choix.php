...
<form>
	...
	<input type="button"   value= "Livrer ">
	</a>
	<a href="check_afficherlivreur01.php">
	<input type="button"   value= "consulter Livreur ">
	</a>
	
	
	<br><br><br>
	<a href="checkout_livraison.php">
	<input type="button"   value= " Livraison ">

	</a>
	<a href="check_afficherlivraison.php">
	<input type="button"   value= "consulter Livraison ">
	</a>
