...
<br><br><br>
 ...
 CIN: <input type="number" name="Cin" value="<?PHP echo $Cin ?>">
  ...
  <br><br>
   Nom Entreprise: <input type="text" name="NomEntreprise" value="<?PHP echo $NomEntreprise ?>">

  <br><br>
   Telephone: <input type="number" name="Telephone" value="<?PHP echo $Telephone?>">

  <br><br>
   Gouvernerat : <input type="text" name="Gouvernerat" value="<?PHP echo $Gouvernerat?>">
  ...
  <br><br>
   Code Postal : <input type="number" name="CodePostal" value="<?PHP echo $CodePostal ?>" >
...
if (isset($_POST['modifier'])){
  $livreur =new livreur($_POST['Cin'],$_POST['Nom'],$_POST['Prenom'],$_POST['Adresse'],$_POST['Ville'],$_POST['NomEntreprise'],$_POST['Telephone'],$_POST['Gouvernerat'],$_POST['Email'],$_POST['Pays'],$_POST['CodePostal']);
