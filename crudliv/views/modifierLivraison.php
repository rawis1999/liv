...
<br><br><br>
 ...
 Identifiant: <input type="text" name="Identifiant" value="<?PHP echo $Identifiant ?>">
 
  <br><br>
   Date Debut : <input type="date" name="DateDebut" value="<?PHP echo $DateDebut?>">
  
  <br><br>
   Date fin : <input type="date" name="DateFin" value="<?PHP echo $DateFin ?>">
...
<input type="hidden" name="id_ini" value="<?PHP echo $siwar;?>">

  <a href="check_afficherlivraison.php">
...
if (isset($_POST['modifier'])){
	$livraison =new livraison($_POST['Identifiant'],$_POST['DateDebut'],$_POST['DateFin']);
