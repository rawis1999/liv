...
<form method="POST" action="ajouterLivraison.php">  
  Id: <input type="text" name="Identifiant"  id="id">
 
  <br><br>
   Date Debut: <input type="" name="DateDebut"  value="<?php echo date("Y-m-d" );?>" id="dated">
  
  <br><br>
   Date Fin: <input type="Date" name="DateFin" id="datef">
