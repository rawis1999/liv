...
<script type="application/x-javascript"> addEventListener("load", function() { setTimeout(hideURLbar, 0); }, false);
		function hideURLbar(){ window.scrollTo(0,1); } </script>ù
<!-- //for-mobile-apps -->
<link href="C:/wamp64/www/web/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="C:/wamp64/www/web/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->
<script type="text/javascript" src="C:/wamp64/www/web/js/jquery-2.1.4.min.js"></script>
<!-- //js -->
<!-- cart -->
	<script src="C:/wamp64/www/web/js/simpleCart.min.js"></script>
<!-- cart -->
<!-- for bootstrap working -->
	<script type="text/javascript" src="C:/wamp64/www/web/js/bootstrap-3.1.1.min.js"></script>
<!-- //for bootstrap working -->
<link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
<link href='//fonts.googleapis.com/css?family=Lato:400,100,100italic,300,300italic,400italic,700,900,900italic,700italic' rel='stylesheet' type='text/css'>
<script src="C:/wamp64/www/web/js/jquery.easing.min.js"></script>
</head>
<body>
<!-- header -->
<div class="header">
...
<div class="header-bot">
	<div class="container">
		<div class="col-md-3 header-left">
			<h1><a href="index.html"><img src="C:/wamp64/www/web/images/logo3.png"></a></h1>
		</div>
			  ...
			  <div class="container-fluid">
				...
				<div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
				 <ul class="nav navbar-nav menu__list">
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									<div class="col-sm-6 multi-gd-img1 multi-gd-text ">
										<a href="mens.html"><img src="C:/wamp64/www/web/images/woo1.jpg" alt=" "/></a>
									</div>
							...
							<ul class="dropdown-menu multi-column columns-3">
								<div class="row">
									...
									<div class="col-sm-6 multi-gd-img multi-gd-text ">
										<a href="womens.html"><img src="C:/wamp64/www/web/images/woo.jpg" alt=" "/></a>
									</div>
									<div class="clearfix"></div>
								</div>
							</ul>
					...
					<li class=" menu__item"><a class="menu__link" href="C:/wamp64/www/web/contact.html">contact</a></li>
				  </ul>
				</div>
			  </div>
			</nav>	
...
<form method="POST" action="ajouterLivraison.php">  
  Id: <input type="text" name="Identifiant" >
 
  <br><br>
   Date Debut: <input type="Date" name="DateDebut" >
